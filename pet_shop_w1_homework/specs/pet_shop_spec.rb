...
# test 1
  ...
  def test_add_or_remove_cash__remove
    add_or_remove_cash(@pet_shop,-10) #METHOD NAME!!!!!!!! shares same method as above
    cash = total_cash(@pet_shop)
  ...
  def test_remove_pet_by_name
    ...
    pet = find_pet_by_name(@pet_shop,"Arthur")# test 10 and 11
    assert_equal(nil, pet)
  end
  ...
  def test_add_pet_to_stock
    ...
    count = stock_count(@pet_shop) #test 7
